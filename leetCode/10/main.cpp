...
void solve(std::istream& in, std::ostream& out)
{
    ...
    out << equal(s.isMatch("aa", "a*"), true) << std::endl;
    out << equal(s.isMatch("ab", ".*"), true) << std::endl;
    out << equal(s.isMatch("abcd", ".*cdd*"), true) << std::endl;
    out << equal(s.isMatch("abcdg", ".*cdd*"), false) << std::endl;
    out << equal(s.isMatch("aab", "c*a*b"), true) << std::endl;
}
