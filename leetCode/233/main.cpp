...
public:
    int countDigitOne(int n) {
        int res = 0;
        long long order = 1000000000;

        while (order)
        {
            res += n / (order * 10) * order;
...
void solve(std::istream& in, std::ostream& out)
{
    ...
    v = {2, 3};
    out << (s.countDigitOne(13) == 6) << std::endl;
    out << (s.countDigitOne(20) == 12) << std::endl;
    out << (s.countDigitOne(22) == 13) << std::endl;
    out << (s.countDigitOne(92) == 20) << std::endl;
    out << (s.countDigitOne(101) == 23) << std::endl;
    out << (s.countDigitOne(0) == 0) << std::endl;
}
